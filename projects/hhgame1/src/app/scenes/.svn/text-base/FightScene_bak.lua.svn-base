...
function FightScene:ctor()
 print("FightScene ctor()")
    ...
    self.initHerosData = {
        player = {
            size = 3,
            ['1'] = {id = 1,type="animal",life=1200,pos=1,hero="heros/hero001.png",icon="icons/icon001.png",skeletonID=1,
                attHurt=149,skiHurt=240,actionTime=13,isNpc=false,autoAttType=1},
            ['2'] = {id = 2,type="animal",life=2200,pos=3,hero="heros/hero002.png",icon="icons/icon002.png",skeletonID=2,
                attHurt=210,skiHurt=160,actionTime=17,isNpc=false,autoAttType=2},
            ['3'] = {id = 3,type="hero",life=2200,pos=7,hero="heros/heroA.png",icon="icons/iconA.png",skeletonID=5,
                attHurt=0,skiHurt=520,actionTime=10,isNpc=false,autoAttType=2}
        },
        npc = {
            ['npc1'] = {
                size = 3,
                ['1'] = {id = 1,type="animal",life=300,pos=1,hero="heros/hero004.png",icon="icons/BattleUnit004.png",skeletonID=3,
                    attHurt=83,skiHurt=130,actionTime=15,isNpc=true,autoAttType=1},
                ['2'] = {id = 2,type="animal",life=300,pos=6,hero="heros/hero005.png",icon="icons/BattleUnit005.png",skeletonID=4,
                    attHurt=99,skiHurt=240,actionTime=13,isNpc=true,autoAttType=1},
                ['3'] = {id = 3,type="hero",life=600,pos=7,hero="heros/heroB.png",icon="icons/BattleCharMale.png",skeletonID=6,
                    attHurt=0,skiHurt=410,actionTime=11,isNpc=true,autoAttType=2},
            },
            ['npc2'] = {
                size = 3,
                ['1'] = {id = 1,type="animal",life=600,pos=3,hero="heros/hero003.png",icon="icons/BattleUnit003.png",skeletonID=3,
                    attHurt=83,skiHurt=130,actionTime=15,isNpc=true,autoAttType=1},
                ['2'] = {id = 2,type="animal",life=600,pos=5,hero="heros/hero005.png",icon="icons/BattleUnit005.png",skeletonID=4,
            ...
            ['npc3'] = {
                size = 3,
                ['1'] = {id = 1,type="animal",life=1300,pos=2,hero="heros/hero003.png",icon="icons/BattleUnit003.png",skeletonID=3,
                    attHurt=83,skiHurt=130,actionTime=15,isNpc=true,autoAttType=2},
                ['2'] = {id = 2,type="animal",life=1300,pos=4,hero="heros/hero004.png",icon="icons/BattleUnit004.png",skeletonID=4,
                    attHurt=99,skiHurt=240,actionTime=13,isNpc=true,autoAttType=1},
                ['3'] = {id = 3,type="hero",life=600,pos=7,hero="heros/heroB.png",icon="icons/BattleCharMale.png",skeletonID=6,
                    attHurt=0,skiHurt=410,actionTime=11,isNpc=true,autoAttType=2},
            }
...
function FightScene:initHeros()
    ...
    self.redLayer = display.newColorLayer(cc.c4b(255, 0, 0, 0))
...
function FightScene:initPlayerHero( initHerosData )    
    ...
    for i=1, playerSize do
        ...
        local z = display.height - p.y

        self.playerHeros[tostring(i)] = Hero.new(heroInitData)
            :align(display.CENTER, display.left + p.x, display.cy + p.y)
...
function FightScene:initNPCHero( initHerosData , idx)    
    ...
    for i=1, self.npcSize do
        ...
        self.npcHeros[tostring(i)] = Hero.new(heroInitData)
            :align(display.CENTER, display.right - p.x, display.cy + p.y)
            :addTo(self.fightLayer, z)
    end
end
